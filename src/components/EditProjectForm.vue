<template>
    <div class="w-[400px] h-[250px] bg-white rounded-xl border-2 ml-14   absolute inset-1/3  z-10">
        <h1 class="font-semibold text-xl text-center mt-10 mb-5">Project settings</h1>
        <form>
            <div class="ml-20">
            <div class="mb-1">
            ...
            <div class="text-center m-10">
                <button @click="submitForm(projectEdit)" type="button" class="border-solid border-2  px-2 hover:bg-[#CCDCE1] text-black font-semibold rounded mr-2">Save</button>
